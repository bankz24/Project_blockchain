...
use self::sha2::{Sha256, Digest}; //for generating our hash function
use std::fmt::Write;

#[derive(Debug, Clone, Serialize)] //all of this properties are needed for the transaction
struct Transaction {
    sender: String,
    receiver: String,
    amount: f32,
...
impl Chain {
    ...
    pub fn generate_new_block(&mut self) -> bool {
        ...
        // in the below code we are creating a block, setting all the information of the block then
        ...
        println!("{:#?}", &block); //adding block to the chain then returning true if errtin is ok
    ...
    pub fn last_hash(&self) -> String {
        ...
        Chain::hash(&block.header) //lasthash
    }
